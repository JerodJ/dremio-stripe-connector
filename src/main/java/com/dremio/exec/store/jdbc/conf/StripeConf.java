...
@SourceType(value = "StripeARP", label = "Stripe",uiConfig = "stripe-layout.json")
public class StripeConf extends AbstractArpConf<StripeConf> {
  private static final String ARP_FILENAME = "arp/implementation/stripe-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.stripe.StripeDriver";
